...
import { SOCIAL_ICONS, SOCIAL_LABELS } from "@/components/footer";
...
export function HeroSlide() {
  ...
  const { appStoreUrl, googlePlayUrl, socialLinks } = useSiteConfig();
  ...
  return (
    <SlideContainer backgroundStyle="linear-gradient(135deg, #0A1810 0%, #1B4332 55%, #0A1810 100%)">
      ...
      <div className="relative z-10 min-h-full flex items-center container mx-auto px-4 md:px-6 py-10 md:py-8">
        <div
          className={`grid lg:grid-cols-2 gap-10 lg:gap-8 items-center w-full ${isRTL ? "lg:grid-flow-col-dense" : ""}`}
        >
          {/* Left column — copy */}
          <motion.div
          ...
          >
            ...
            {/* Headline */}
            <h1
              className={`text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-black tracking-tighter text-white ${isRTL ? "leading-[1.35]" : "leading-[1.05]"}`}
            >
              {tr.headline1}
              <br />
            ...
            {/* Store buttons */}
            <div
              className={`flex flex-col gap-2 md:gap-3 ${isRTL ? "items-end" : ""}`}
            >
              ...
              >
                ...
                >
                  ...
                  >
                    <span className="text-[9px] font-semibold uppercase tracking-wider opacity-60 leading-none">
                      {tr.appStorePrefix}
                    </span>
                ...
                >
                  <Play
                    className="w-5 h-5 md:w-6 md:h-6 text-[#FFEB3B]"
                    fill="currentColor"
                  />
                  <div
                    className={`flex flex-col ${isRTL ? "items-end" : "items-start"}`}
            ...
            >
              <div className="flex -space-x-2">
                {[1, 2, 3, 4].map((i) => (
                  <div
                    key={i}
                    className="w-7 h-7 md:w-8 md:h-8 rounded-full border-2 border-[#0A1810] bg-[#388E3C] flex items-center justify-center overflow-hidden"
                  >
                    <img
              ...
              <div className={isRTL ? "text-right" : ""}>
                <div
                  className={`flex items-center gap-0.5 ${isRTL ? "flex-row-reverse justify-end" : ""}`}
                >
                  {[1, 2, 3, 4, 5].map((i) => (
                    <svg
                      key={i}
                      className="w-3 h-3 text-[#FFEB3B]"
                      fill="currentColor"
                      viewBox="0 0 20 20"
                    >
            ...
            {enabledSocials.length > 0 && (
              <div
                className={`flex items-center flex-wrap gap-3 ${isRTL ? "flex-row-reverse justify-end" : ""}`}
              >
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              ...
              >
                ...
                <div className={isRTL ? "text-right" : ""}>
                  ...
                  <p className="text-base font-bold text-[#FFEB3B]">
                    {tr.onTheWay}
                  </p>
                </div>
              </motion.div>
